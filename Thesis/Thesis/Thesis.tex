...
\section {Othello}
\label{sec:Othello}
According to \cite{RULES} Standard Othello is a game played on a board made up of eight by eight tiles. Two players, black and white, take turns setting a stone in their respective color to the board.
