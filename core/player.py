...
class MCPlayer(DeepRLPlayer):
    ...
    def __generate_training_labels__(self, winner_color):
        self.training_labels = [config.get_result_label(winner_color, self.color) - (0.01 * self.num_moves) for sample in self.training_samples]
...
class TDPlayer(MCPlayer):
    ...
    def __generate_training_labels__(self, winner_color):
        ...
        self.training_labels.append(config.get_result_label(winner_color, self.color) - (0.01 * self.num_moves))
